---
title: "9 — Model an N-trace transmission line"
jupyter: python3
execute:
  enabled: false
---
...
The loader preserves full matrices, extraction frequency, labels, the caller's
asserted +z convention, and content hash; it does not infer direction,
interpolate, or run AEDT.
...
[Previous](08_use_custom_component.qmd) · [Course map](../../docs/index.qmd) · [Next: compensate probes](10_compensate_probes.qmd) · [Concept: compilation](../../docs/concepts/compilation-coordinates-and-network-views.qmd#network-view-lineage)
